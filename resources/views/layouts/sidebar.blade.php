...
<div class="app-sidebar__overlay" data-toggle="sidebar"></div>
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">موقع الاخبار</li>
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/') }}">جميع المستخدمين</a></li>
							<li><a class="slide-item" href="{{ url('') }}">صلاحيات المستخدمين</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/') }}">ترتيب</a></li>
						</ul>
					</li>
					...
					<li class="side-item side-item-category">taaggg</li>
